...
import { useGetPreferModesQuery, useDeleteModeMutation } from "@/services/modes.service";
import { useState } from "react";
import { CreateModeForm } from "@/app/modes/_components/create-mode-form";
import { Mode } from "@/types/api/Mode";

export function ModePrefer() {
  const { isLoading, error, data } = useGetPreferModesQuery();
  ...
  if (error) {
    return (
      <ShowcaseSection title="Modes - Tu préfères" className="!p-6.5">
